...
const AUDIO = {
  OUT: new Audio(
    'https://www.myinstants.com/media/sounds/pokeball_sound_effects_mp3cut_1.mp3'
  ),
  IN: new Audio(
    'https://www.myinstants.com/media/sounds/pokeball_sound_effects_mp3cut_2.mp3'
  ),
}
AUDIO.IN.volume = AUDIO.OUT.volume = 0.25
// Configurations
