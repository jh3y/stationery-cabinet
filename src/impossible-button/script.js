...
//       <Fragment>
//         <div className="bear__wrap">
//           <div ref={s => (this.SWEAR = s)} className="bear__swear">
//             #@$%*!
//           </div>
//           <svg
//             ref={b => (this.BEAR = b)}
...
//           </svg>
//         </div>
//         <div ref={w => (this.ARM_WRAP = w)} className="bear__arm-wrap">
//           <svg
//             ref={a => (this.ARM = a)}
//             className="bear__arm"
//             viewBox="0 0 250.00001 99.999997"
...
//           </svg>
//         </div>
//         <div ref={p => (this.PAW = p)} className="bear__paw" />
//         <div className="mask" />
//         <div className="checkbox" onMouseOver={onHover} onMouseOut={offHover}>
//           <input type="checkbox" onChange={onChange} checked={checked} />
//           <div ref={b => (this.BG = b)} className="checkbox__bg" />
//           <div
//             ref={i => (this.INDICATOR = i)}
